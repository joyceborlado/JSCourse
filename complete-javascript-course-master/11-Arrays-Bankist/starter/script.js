...
console.log(arr.slice()); // creates a shallow copy of the array just like:
console.log([...arr]);
...
const checkDogs = function (dogsJulia, dogsKate) {
  ...
  dogs.forEach(function (age, i, arr) {
    const puppyOrAdult = age >= 3 ? 'an adult' : 'a puppy';

    console.log(
      `Dog number ${i + 1} is ${puppyOrAdult}, and is ${age} years old`
    );
  });
};
